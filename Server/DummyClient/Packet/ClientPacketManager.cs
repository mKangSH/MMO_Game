...
public class PacketManager
{
    ...
    public void Register()
    {
		...
		_makeFunc.Add((ushort)PacketID.S_BroadcastExitGame, MakePacket<S_BroadcastExitGame>);
        _handler.Add((ushort)PacketID.S_BroadcastExitGame, PacketHandler.S_BroadcastExitGameHandler);
